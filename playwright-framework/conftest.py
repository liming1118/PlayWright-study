...
def pytest_configure(config):
    ...
    # 添加接口地址与项目名称
    config._metadata["项目名称"] = "playwright+pytest+POM 完成WEB UI自动化 "
    config._metadata["项目地址"] = "https://github.com/liming1118/PlayWright-study.git"
...
def pytest_html_results_summary(prefix):
    ...
    :return:
    """
    prefix.extend([html.p("所属部门: 用户运营部门QA组")])
    prefix.extend([html.p("测试人员: 李铭、张三")])
    prefix.extend(
        [
            html.style(
                """
